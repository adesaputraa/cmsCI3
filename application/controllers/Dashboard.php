		...
		if($this->form_validation->run() != false){
			...
			public function kategori_update()
			{
				...
				if($this->form_validation->run() != false){
					...
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>Data Harus Tidak Boleh Kosong!</div>');
					$data['kategori'] = $this->m_data->edit_data($where,'kategori')->result();
					$this->load->view('dashboard/header');
					$this->load->view('dashboard/kategori_edit',$data);
					$this->load->view('dashboard/footer');
			...
			public function artikel()
			{
				...
				$this->load->view('dashboard/header',$data);
				$this->load->view('dashboard/artikel/artikel',$data);
				$this->load->view('dashboard/footer');
			}
			...
			public function artikel_edit($id){
				...
				$this->load->view('dashboard/header');
				$this->load->view('dashboard/artikel/edit',$data);
				$this->load->view('dashboard/footer');
			}

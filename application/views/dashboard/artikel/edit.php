							...
							<div class="col-xl-7">
								<div class="card mb-4 py-3 border-left-primary">
									...
									<form method="post" action="<?= base_url('dashboard/artikel_update') ?>"enctype="multipart/form-data">
										<label>Judul</label>
                                            <input type="hidden" name="id" value="<?= $ade->artikel_id; ?>">
                                             <input type="text" name="judul" class="form-control" value="<?php echo $ade->artikel_judul; ?>">
											 <br/>
											 <?= form_error('judul'); ?>
									</div>
										...
										<div class="col-xl-12 col-lg-10">
												...
												<textarea class="form-control" id="editor" name="konten"><?= $ade->artikel_konten; ?></textarea>
												</div>
										</div>
                            	</div>
							</div>
									...
									<div class="card-body">
										...
										<select class="form-control" name="kategori">
											...
											<?php foreach($kategori as $k){ ?>
												<option <?php if($ade->artikel_kategori == $k->kategori_id){echo "selected='selected'";} ?> 
